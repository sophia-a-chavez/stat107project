...
barplot(race_counts_matrix, beside = TRUE, col = colors,
        ...
        args.legend = list(x = "topright", inset = c(-0.05, 0)), ylim = c(0,1200))
...
Findings: During peak BLM movement periods, the percentage of officers with turned-on body cameras increases from approximately 14% to 21%. Additionally, there is a positive correlation between average fatalities per day and the percentage of turned-on body cameras throughout all highlighted datasets. Questions: What are the parameters when classifying a person's race_name as "unknown"? Additionally, why is there a substantial jump in fatalities per day with unknown races, specifically beginning in 2020
